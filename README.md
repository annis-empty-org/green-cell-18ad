...
```
npm create cloudflare@latest -- --template=cloudflare/templates/green-cell-18ad
```

## Preview Deployment

A live public deployment of this template is available at [https://green-cell-18ad.templates.workers.dev](https://green-cell-18ad.templates.workers.dev)
